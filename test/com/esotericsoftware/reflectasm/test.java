...
public class test implements Accessor<SomeClass> {
    ...
    public test() {
        ...
        this.classInfo.fieldNames = new String[]{"name", "intValue", "bu"};
        this.classInfo.fieldTypes = new Class[]{String.class, Integer.TYPE, Boolean.TYPE};
        this.classInfo.fieldModifiers = new Integer[]{Integer.valueOf(2), Integer.valueOf(2), Integer.valueOf(8)};
        this.classInfo.constructorParamTypes = new Class[][]{new Class[0]};
